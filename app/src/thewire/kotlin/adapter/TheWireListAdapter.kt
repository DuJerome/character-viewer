package com.sample.thewire.adapter
...
class TheWireListAdapter(
    private val context: Context
) : PagingDataAdapter<Character, TheWireListAdapter.ViewHolder>(COMPARATOR) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            val nextFragmentIntent: Intent = Intent(context, SimpsonsCharacterFragment::class.java)
